...
class AccountMove(models.Model):
            ...
            for line in self.env['account.move.line'].search(domain):
                ...
                if line.currency_id == move.currency_id:
                    ...
                    amount = line.company_currency_id._convert(
                        ...
                        move.company_id,
                        line.date,
                        manual_rate=move.manual_currency_exchange_rate if self.apply_manual_currency_exchange else None
    ...
    def _compute_partner_credit_warning(self):
        for move in self:
            ...
            if show_warning:
                amount_total_currency = move.currency_id._convert(move.tax_totals['amount_total'], move.company_currency_id, move.company_id, move.date,manual_rate=move.manual_currency_exchange_rate if self.apply_manual_currency_exchange else None
)
    ...
    def _inverse_amount_total(self):
        for move in self:
            ...
            balance = move.currency_id._convert(amount_currency, move.company_currency_id, move.company_id, move.invoice_date or move.date,manual_rate=move.manual_currency_exchange_rate if self.apply_manual_currency_exchange else None
)
    ...
    def _recompute_cash_rounding_lines(self):
        ...
        def _compute_cash_rounding(self, total_amount_currency):
            ...
            if self.currency_id == self.company_id.currency_id:
                ...
                diff_balance = self.currency_id._convert(diff_amount_currency, self.company_id.currency_id, self.company_id, self.invoice_date or self.date,manual_rate=move.manual_currency_exchange_rate if self.apply_manual_currency_exchange else None
)
