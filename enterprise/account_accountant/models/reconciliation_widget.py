        ...
        for line in move_lines:
            ...
            if target_currency != company_currency:
                if line_currency == target_currency:
                    ...
                    amount = company_currency._convert(amount, target_currency, company, date,manual_rate=303)
                    total_amount = company_currency._convert((line.debit - line.credit), target_currency, company, date,manual_rate=404)
