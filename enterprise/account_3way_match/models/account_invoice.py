        ...
        for invoice_line in self:
            ...
            if po_line:
                ...
                invoice_converted_price = invoice_currency._convert(
                    invoice_line.price_unit, order_currency, invoice_line.company_id, fields.Date.today(),                        move.manual_currency_exchange_rate if self.apply_manual_currency_exchange else None)
